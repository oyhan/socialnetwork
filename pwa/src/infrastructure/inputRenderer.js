...
export function InputRenderer(props) {
    ...
    var { Name: name, Type: type, Required: required, DisplayName: displayName, DefaultValue: defaultValue,
        DataSource, Disabled, Controled, multiple, Hint, noFullWidth, ...other } = props;
    var InputLabelRef = null;

    const fullWidth = noFullWidth ? false : true;
